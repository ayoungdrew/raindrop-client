...
// promise chained
var setAllProducts = function setAllProducts(data) {
  store.allProducts = {};
...
var sortProducts = function sortProducts(sortParam, sortOrder) {
...
// promise chained
var setAllLocalCarts = function setAllLocalCarts(data) {
...
var setNewestActiveCart = function setNewestActiveCart() {
  var activeCarts = store.allMyCarts.filter(function (cart) {
    return cart.purchased === false;
  });
...
// parses past purchase carts out from all of a users carts and stores locally
var setPastPurchases = function setPastPurchases() {
  store.pastPurchases = store.allMyCarts.filter(function (cart) {
    return cart.purchased === true;
  });
};

// sets all local cart totals
var setAllCartTotals = function setAllCartTotals() {
...
// the cart object
var setCartTotal = function setCartTotal(cart) {
  var total = 0;
...
var packageCartDataForAPI = function packageCartDataForAPI(cart) {
  var packagedCart = {
    id: cart.id,
    data: {
      cart: {
...
var addItemToCart = function addItemToCart(productId) {
  if (store.activeCart === undefined) {
    return 'new cart needed';
  } else {
    var product = store.allProducts[productId];
...
var deleteItemFromCart = function deleteItemFromCart(productId) {
  ...
  if (store.activeCart.cartProducts.length === 1) {
    ...
    var product = store.activeCart.cartProducts.find(function (product) {
      return product._id === productId;
    });
    // console.log('product obj is ', product)
    var index = store.activeCart.cartProducts.indexOf(product);
...
var setCartProductQuantities = function setCartProductQuantities(cartProducts) {
  // initialize the array we'll be pushing into and returning at the end
  var packagedCartArray = [];
  ...
  cartProducts.forEach(function (product) {
    ...
    var productInPackagedArray = packagedCartArray.find(function (pushedProduct) {
    ...
    if (productInPackagedArray === undefined) {
      ...
      var productIndex = packagedCartArray.indexOf(productInPackagedArray);
...
var setPastPurchaseProductQuantities = function setPastPurchaseProductQuantities(pastPurchases) {
  var packagedPastPurchases = [];
  for (var i = 0; i < pastPurchases.length; i++) {
    var purchase = pastPurchases[i];
    // console.log('purchase.cartProducts is ', purchase.cartProducts)

    var parsedDate = new Date(purchase.updatedAt);
...
module.exports = {
  setAllLocalCarts: setAllLocalCarts,
  setAllProducts: setAllProducts,
  addItemToCart: addItemToCart,
  deleteItemFromCart: deleteItemFromCart,
  setCartProductQuantities: setCartProductQuantities,
  setPastPurchaseProductQuantities: setPastPurchaseProductQuantities,
...
var getOneCart = function getOneCart(cartId) {
  return $.ajax({
...
var updateCart = function updateCart(cartId, data) {
  return $.ajax({
    url: config.apiUrl + '/carts/' + cartId,
    method: 'PATCH',
    headers: {
...
var purchasedTrue = function purchasedTrue(data) {
  return $.ajax({
...
var getProductsBySearchEntry = function getProductsBySearchEntry(searchEntry) {
  return $.ajax({
...
var getProductsSortedByPrice = function getProductsSortedByPrice(sortOrder, currentProductCategory) {
  return $.ajax({
...
module.exports = {
  ...
  getProductsBySearchEntry: getProductsBySearchEntry,
  getProductsSortedByPrice: getProductsSortedByPrice
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var cartApi = __webpack_require__(7);
var cartUi = __webpack_require__(46);
var cartParse = __webpack_require__(3);
var getFormFields = __webpack_require__(10);
var store = __webpack_require__(1);

// const showActiveCartTemplate = require('../templates/active-cart-listing.handlebars')

var onGetActiveCart = function onGetActiveCart(event) {
  store.activeCart ? cartUi.getActiveCartSuccess() : cartUi.getActiveCartFailure();
  return event;
};

var onGetPastPurchases = function onGetPastPurchases(event) {
...
var onGetCarts = function onGetCarts(event) {
  // console.log('Clicked see all carts button')

  cartApi.getCarts()
  // store all cart data locally, sort past carts, set cart totals
  .then(cartParse.setAllLocalCarts).then(cartUi.getCartsSuccess).catch(cartUi.getCartsFailure);
};

var onGetOneCart = function onGetOneCart(event) {
  event.preventDefault();
  // console.log('Clicked get one cart button')
  var cartId = $('#get-one-cart input').val();
  // console.log('cartId is: ', cartId)

  cartApi.getOneCart(cartId).then(cartUi.getOneCartSuccess).catch(cartUi.getOneCartFailure);
};
...
var onCreateCart = function onCreateCart(event) {
  event.preventDefault();
  ...
  cartApi.createCart(data).then(cartUi.createCartSuccess).catch(cartUi.createCartFailure);
};

// only used for testing purposes, can delete once mvp is met
var onUpdateCart = function onUpdateCart(event) {
  event.preventDefault();
  // console.log('Clicked update cart button')

  var cartId = $('#update-cart input').val();
  // console.log('cartId is: ', cartId)
  var data = getFormFields(this);
  data.cart.cartProducts = data.cart.cartProducts.split(' ');
  // console.log('patch data is ', data)

  cartApi.updateCart(cartId, data).then(cartUi.updateCartSuccess).catch(cartUi.updateCartFailure);
};
...
var onAddToCart = function onAddToCart(event) {
  ...
  var updatedCart = cartParse.addItemToCart(productId);
  // if updatedCart === 'new cart needed'
  if (updatedCart === 'new cart needed') {
    onCreateNewCart(productId);
  } else {
    // console.log('Active cart now looks like...', updatedCart.data)
    cartApi.updateCart(store.activeCart._id, updatedCart.data).then(cartUi.addToCartSuccess).then(cartApi.getCarts).then(cartParse.setAllLocalCarts).catch(cartUi.addToCartFailure);
  }
};
...
var onCreateNewCart = function onCreateNewCart(productId) {
  ...
  cartApi.createCart(data).then(cartUi.addToCartSuccess).then(cartApi.getCarts).then(cartParse.setAllLocalCarts).catch(cartUi.createCartFailure);
};

// deletes a selected item from cart. If cart has only one item, destroys the cart
var onDeleteFromCart = function onDeleteFromCart(event) {
  event.preventDefault();
  ...
  var updatedCart = cartParse.deleteItemFromCart(productId);
  ...
  if (updatedCart === 'marked for deletion') {
    ...
    .then(cartApi.getCarts).then(cartParse.setAllLocalCarts).then(onGetActiveCart).catch(cartUi.deleteCartFailure);
  } else {
    cartApi.updateCart(store.activeCart._id, updatedCart.data)
    // TODO need a remove Item from cart update success UI function
    // next 3 .thens refresh the local cart data to match the cart data from
    // the API, and re-render the cart view
    .then(cartApi.getCarts).then(cartParse.setAllLocalCarts).then(onGetActiveCart)
    // TODO need a remove Item from cart update failure UI function
    .catch(cartUi.addToCartFailure);
  }
};

var onDeleteCart = function onDeleteCart(event) {
  event.preventDefault();
  // console.log('Clicked delete cart button')
  var cartId = $('#delete-cart input').val();
  // console.log('cartId is: ', cartId)

  cartApi.deleteCart(cartId).then(cartUi.deleteCartSuccess).catch(cartUi.deleteCartFailure);
};
...
module.exports = {
  ...
  onGetActiveCart: onGetActiveCart
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var productEvents = __webpack_require__(26);
var cartEvents = __webpack_require__(14);
var checkoutEvents = __webpack_require__(49);
...
var cartApi = __webpack_require__(7);
var productApi = __webpack_require__(9);
var getFormFields = __webpack_require__(10);
...
var onSignIn = function onSignIn(event) {
  ...
  var data = getFormFields(this);
  api.signIn(data).then(ui.signInSuccess).then(productApi.getProducts).then(cartParse.setAllProducts).then(cartApi.getCarts).then(cartParse.setAllLocalCarts).catch(ui.signInFailure);
};
...
var onBackHome = function onBackHome(event) {
  // console.log('hey')
  $('#intro-header, #intro-see-all-products, #intro-about-raindrop').show();
  productApi.getProducts().then(cartParse.setAllProducts);
...
var productApi = __webpack_require__(9);
var productUi = __webpack_require__(27);
var cartParse = __webpack_require__(3);
var store = __webpack_require__(1);
...
var onGetProducts = function onGetProducts(event) {
  ...
  // store all product objects locally in a hash, where each item obj is
  // accessible by its product ID
  .then(cartParse.setAllProducts).then(productUi.getProductsSuccess).catch(productUi.getProductsFailure);
};

var onGetProductsByCategory = function onGetProductsByCategory(event) {
  // console.log('Clicked', this)
  $('#intro-header, #intro-see-all-products, #intro-about-raindrop, #user-account').hide();
  var category = $(this).attr('data-id');
  store.currentProductCategory = category;

  productApi.getProductsByCategory(category).then(productUi.getProductsSuccess).catch(productUi.getProductsFailure);
};

var onGetProductDetail = function onGetProductDetail(event) {
  // console.log('Clicked .product-detail')
  $('#intro-header, #intro-see-all-products, #intro-about-raindrop, #user-account').hide();
  var productId = $(this).attr('data-id');
  // console.log(store.allProducts[productId])
  var itemObject = store.allProducts[productId];
  productUi.getProductDetailSuccess(itemObject);
};

var onSearchProducts = function onSearchProducts(event) {
  event.preventDefault();
  var searchEntry = $('#search-products input').val();
  // console.log('searchEntry is ', searchEntry)

  productApi.getProductsBySearchEntry(searchEntry).then(productUi.getProductsSuccess).catch(productUi.getProductsFailure);
};

var onSortProducts = function onSortProducts(event) {
  event.preventDefault();
  ...
  // console.log('store.currentlyViewedProducts.products is ', store.currentlyViewedProducts.products)
  var data = cartParse.sortProducts(sortParam, sortOrder);
...
var onSortByPrice = function onSortByPrice(event) {
  event.preventDefault();
  var sortOrder = $(this).attr('data-id');
  // console.log('sortOrder is ', sortOrder)

  productApi.getProductsSortedByPrice(sortOrder, store.currentProductCategory).then(productUi.getProductsSuccess).catch(productUi.getProductsFailure);
};

var productHandlers = function productHandlers() {
  productApi.getProducts().then(cartParse.setAllProducts);
...
var showProductsTemplate = __webpack_require__(28);
var showProductDetailTemplate = __webpack_require__(45);
var toast = __webpack_require__(8);
var store = __webpack_require__(1);
...
var getProductsSuccess = function getProductsSuccess(data) {
  ...
  if (data.products.length === 0) {
    ...
    var showProducts = showProductsTemplate({ products: data.products });
...
var getProductsFailure = function getProductsFailure() {
  toast.failure('Server connection error. Please try again later.');
  // console.log('Failed to get all products')
  $('#search-products input').val('');
};

var getProductDetailSuccess = function getProductDetailSuccess(productObj) {
  // console.log('let\'s show detils for...', productObj)
  $('#product-detail-content').show();
  var showProduct = showProductDetailTemplate({ product: productObj });
...
var getProductDetailFailure = function getProductDetailFailure() {
  toast.failure('Server connection error. Please try again later.');
...
module.exports = {
  ...
  getProductDetailSuccess: getProductDetailSuccess,
  getProductDetailFailure: getProductDetailFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<a href=\"#\">\n<div class=\"col-lg-3 col-md-4 col-sm-6 text-center product-tile\"\nstyle=\"background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, .8)), url("
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imageUrl : stack1), depth0))
    + "); background-position: center; background-size: 120%;\" data-id=\""
    ...
    + "\n      </h4>\n        <button class=\"add-to-cart btn btn-primary add-to-cart-button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + ">\n          Add to Cart\n        </button>\n        <button class=\"add-to-cart btn btn-primary sign-in-to-buy\" data-toggle=\"modal\" data-target=\"#sign-in-modal\">\n          Sign in to Buy\n        </button>\n</div>\n</a>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<!-- <h3>"
    + alias1(((helper = (helper = helpers.product || (depth0 != null ? depth0.product : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"product","hash":{},"data":data}) : helper)))
    + "</h3> -->\n<div class=\"container\">\n  <div class=\"col-sm-12\">\n    <h2 class=\"bread-crumbs\" style=\"font-size: 14px;\">\n\n      <a class=\"all-products-breadcrumb\" href=\"#\">Products</a>\n\n         /\n\n      <a class=\"product-category-breadcrumb\" href=\"#\" data-id=\""
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.category : stack1), depth0))
    + "\" >"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.category : stack1), depth0))
    + "</a>\n\n       / "
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h2>\n  </div>\n<div class=\"col-md-6 product-detail-image\" style=\"background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.1)), url("
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.imageUrl : stack1), depth0))
    + "); background-size: 120%; background-position: center; background-repeat: no-repeat;\">\n</div>\n<div class=\"col-md-4\">\n  <h1>"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h1>\n  <h3>$"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.price : stack1), depth0))
    + "</h3>\n  <p>"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.description : stack1), depth0))
    + "</p>\n  <button class=\"add-to-cart btn btn-primary add-to-cart-button\" data-id="
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1._id : stack1), depth0))
    + ">\n    Add to Cart\n  </button>\n  <button class=\"add-to-cart btn btn-primary sign-in-to-buy\" data-toggle=\"modal\" data-target=\"#sign-in-modal\">\n    Sign in to Buy\n  </button>\n</div>\n<div class=\"col-sm-12 text-center\" style=\"margin: 20px;\">\n  <h4 style=\"line-height: .1;\">\n  Customers who viewed this definitely also <i>bought</i> some of these...\n</h4>\n</div>\n</div>\n";
},"useData":true});
...
var showActiveCartTemplate = __webpack_require__(47);
var showPastPurchasesTemplate = __webpack_require__(48);

var getActiveCartSuccess = function getActiveCartSuccess() {
  // package the cart product data to remove duplicates and set quantity for handlebars
  var cartProductsWithQuantities = cartParse.setCartProductQuantities(store.activeCart.cartProducts);
  var showActiveCart = showActiveCartTemplate({ cartProducts: cartProductsWithQuantities });
  $('#active-cart-content').html(showActiveCart);
  $('#active-cart-total').html('<h2>Total: ' + store.activeCart.total + '</h2>');
};

var getActiveCartFailure = function getActiveCartFailure(error) {
...
var getPastPurchasesSuccess = function getPastPurchasesSuccess() {
  var pastPurchasesWithQuantities = cartParse.setPastPurchaseProductQuantities(store.pastPurchases);
  var showPastPurchases = showPastPurchasesTemplate({ pastPurchases: pastPurchasesWithQuantities });
  var whenToShowPastPurchase = function whenToShowPastPurchase() {
...
var getPastPurchasesFailure = function getPastPurchasesFailure(error) {}
// console.log('Failed to get past purchases')
// console.log(error)


// only used for testing purposes, can delete once mvp is met
;var getCartsSuccess = function getCartsSuccess(data) {}
// console.log('retrieved carts data is: ', data)


// only used for testing purposes, can delete once mvp is met
;var getCartsFailure = function getCartsFailure(error) {
...
// only used for testing purposes, can delete once mvp is met
var getOneCartSuccess = function getOneCartSuccess(data) {}
// console.log('retrieved cart data is: ', data)


// only used for testing purposes, can delete once mvp is met
;var getOneCartFailure = function getOneCartFailure(error) {}
// console.log('Failed to get one cart')
// console.log(error)


// only used for testing purposes, can delete once mvp is met
;var createCartSuccess = function createCartSuccess(data) {}
// console.log('created cart data is: ', data)


// only used for testing purposes, can delete once mvp is met
;var createCartFailure = function createCartFailure(error) {}
// console.log('Failed to create a cart')
// console.log(error)


// only used for testing purposes, can delete once mvp is met
;var updateCartSuccess = function updateCartSuccess(data) {}
// console.log('Successfully updated cart')


// only used for testing purposes, can delete once mvp is met
;var updateCartFailure = function updateCartFailure(error) {
...
var addToCartFailure = function addToCartFailure(error) {
  toast.failure('Server connection error. Please try again later.');
...
module.exports = {
  ...
  getActiveCartSuccess: getActiveCartSuccess,
  getActiveCartFailure: getActiveCartFailure,
  getPastPurchasesSuccess: getPastPurchasesSuccess,
  getPastPurchasesFailure: getPastPurchasesFailure,
  getCartsSuccess: getCartsSuccess,
  getCartsFailure: getCartsFailure,
  getOneCartSuccess: getOneCartSuccess,
  getOneCartFailure: getOneCartFailure,
  createCartSuccess: createCartSuccess,
  createCartFailure: createCartFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"row\">\n  <div class=\"col-xs-4 cart-product-image\" style=\"background: linear-gradient(rgba(0, 0, 0, 0.0), rgba(0, 0, 0, .1)), url("
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imageUrl : stack1), depth0))
    ...
    + "\n        </h5>\n          <h4>\n          Price: $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + "\n          </h4>\n          <button class=\"remove-from-cart btn btn-primary\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + ">\n            Remove One Item\n          </button>\n  </div>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
  ...
  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.cartProducts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <hr>\n  <h3>\n"
    ...
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.cartProducts : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      <div class=\"row\" style=\"margin-bottom: 45px;\">\n        <div class=\"col-md-2\">\n        </div>\n        <div class=\"col-md-4\">\n        </div>\n        <div class=\"col-md-4\">\n    <h4 class=\"past-cart-total\">\n      Total: $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.total : stack1), depth0))
    + "\n    </h4>\n  </div>\n  </div>\n  </div>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "        <div class=\"row\">\n          <div class=\"col-xs-2 past-cart-product-image\" style=\"background: linear-gradient(rgba(0, 0, 0, 0.0), rgba(0, 0, 0, .1)), url("
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imageUrl : stack1), depth0))
    + "); background-position: center; background-size: cover; background-repeat: no-repeat\">\n</div>\n          <div class=\"col-md-4\">\n            <h4 style=\"margin-bottom: 2px;\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h4>\n            <small>\n        Quantity: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1), depth0))
    + "\n      </small>\n          </div>\n          <div class=\"col-md-4\">\n            <h3 class=\"past-cart-product-price\">\n      <small>\n      $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + "\n    </small>\n  </h3>\n          </div>\n        </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pastPurchases : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var checkoutApi = __webpack_require__(50);
var cartApi = __webpack_require__(7);
var cartEvents = __webpack_require__(14);
var $script = __webpack_require__(51);
var cartParse = __webpack_require__(3);
var store = __webpack_require__(1);
  ...
  var handler = StripeCheckout.configure({
    ...
    token: function token(_token) {
      ...
      var tokenData = {
        ...
        // Stripe
      };checkoutApi.createToken(tokenData).then(function (data) {
        $('#cart-modal').modal('hide');
        // console.log('Payment Sent', data)
        return data;
      }).then(cartApi.purchasedTrue).then(cartApi.getCarts).then(cartParse.setAllLocalCarts).then(cartEvents.onGetActiveCart).catch(function (err) {
...
var checkoutHandlers = function checkoutHandlers() {};

module.exports = {
  checkoutHandlers: checkoutHandlers
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
